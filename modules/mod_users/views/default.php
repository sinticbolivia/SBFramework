<?php
?>
<h1><?php _e('My Account', 'users'); ?></h1>
<?php b_do_action('users_account_top_buttons', $user); ?>
<form action="" method="post">
	<input type="hidden" name="mod" value="users" />
	<input type="hidden" name="task" value="save_profile" />
	<div class="row">
		<div class="col-md-2">
			<div id="select-image" href="javascript:;" title="<?php _e('Select user image', 'users'); ?>">
				<img src="<?php print $image_url; ?>" alt="" class="img-thumbnail" />
			</div>
			<div id="uploading" style="display:none;">
				<img src="<?php print BASEURL; ?>/js/fineuploader/loading.gif" alt=""  /><?php _e('Uploading Image', 'users'); ?>
			</div>
		</div>
		<div class="col-md-10">
			<div class="form-row">
	...
	<div id="user-tabs">
		<ul class="nav nav-tabs">
			<li class="nav-item active">
				<a href="#profile" class="nav-link active" data-toggle="tab"><?php _e('Profile', 'users'); ?></a>
			</li>
			<li class="nav-item"><a href="#personal" class="nav-link" data-toggle="tab"><?php _e('Personal', 'users'); ?></a></li>
			<?php b_do_action('user_tabs', $user); ?>
		</ul>
		<div class="tab-content">
				...
				<div class="row">
					<div class="col-xs-12 col-md-6">
						...
						<div class="control-group">
							...
							<input type="password" name="pwd" value="" placeholder="<?php _e('Dejar en blanco para no actualizar.', 'users'); ?>" class="form-control" />
						</div>
					</div>
					<div class="col-xs-12 col-md-6">
		    ...
		    <?php b_do_action('user_tabs_content', $user); ?>
		</div>
	</div><!-- end id="user-tabs" -->
	<div class="control-group">
		<button class="btn btn-primary" type="submit"><?php _e('Save', 'users'); ?></button>
		<?php b_do_action('users_account_buttons', $user); ?>
	</div>
</form>
<script>
window.mod_users = {
