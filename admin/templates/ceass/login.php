...
<div class="cont">
  	<div class="demo">
    	<div class="login">
    		<div><img src="<?php print TEMPLATE_URL; ?>/images/logo.jpg" style="max-width:100%;" /></div>
      			...
      			<form id="form-login" action="<?php print SB_Route::_('login.php'); ?>" method="post">
	        		...
	        		<div class="login__row">
			        	<svg class="login__icon name svg-icon" viewBox="0 0 20 20">
	          			...
	          			<input type="text" name="username" class="login__input name" placeholder="<?php print SBText::_('Username', 'ceass'); ?>"/>
	        		</div>
	        		<div class="login__row">
	          			<svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
	            			<path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
	          			</svg>
	          			<input type="password" name="pwd" class="login__input pass" placeholder="<?php print SBText::_('Password', 'ceass'); ?>"/>
	        		</div>
	        		<button type="submit" class="login__submit"><?php print SBText::_('Sign in', 'ceass'); ?></button>
	        	</form>
      		</div>
    </div>
    <div class="app">
