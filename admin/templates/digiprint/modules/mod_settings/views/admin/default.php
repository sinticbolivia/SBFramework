		...
		<ul class="nav nav-tabs" role="tablist">
  		...
  		<div class="tab-content">
		  				...
		  				<div class="col-md-5">
		  					<div class="control-group">
				  				...
				  				<div class="input-group site_title">
				  					<input type="text" name="settings[SITE_TITLE]" value="<?php print @$settings->SITE_TITLE; ?>" class="form-control" maxlength="30" />
				  			...
				  			<div class="form-group">
				  				...
				  				<select name="settings[LANGUAGE]" class="form-control">
				  					<option value="en_US" <?php print @LANGUAGE == 'en_US' ? 'selected' : ''; ?>><?php print SBText::_('English', 'settings'); ?></option>
				  					<option value="es_ES" <?php print @LANGUAGE == 'es_ES' ? 'selected' : ''; ?>><?php print SBText::_('Spanish', 'settings'); ?></option>
				  				</select>
				  			</div>
	  		...
	  		<div id="branches" class="tab-pane">
	  			<?php lt_include_view('mb', 'admin/branches.default.php'); ?>
	  		</div>
